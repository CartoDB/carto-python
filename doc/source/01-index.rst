...
Welcome to Python SDK Developer Guide
==========================================

This section contains documentation on how to use the different `Python SDK` APIs.

`Python SDK` is a full, backwards incompatible rewrite of the deprecated `cartodb-python` SDK. Since the initial rewrite, `Python SDK` has been loaded with a lot of new features, not present in old `cartodb-python`.
...
Please, refer to the [examples]({{site.pythonsdk_docs}}/reference/) or the source code for further details about modules, methods and parameters.
