...
def test_cloud_organization_url():
    user1 = APIKeyAuthClient('https://carto.com/u/user1/a/b/c',
                             API_KEY).username
    user2 = APIKeyAuthClient('https://www.carto.com/u/user2',
                             API_KEY).username
    user3 = APIKeyAuthClient('http://www.carto.com/u/user3/a/b/c',
                             API_KEY).username
    assert user1 == 'user1'
    assert user2 == 'user2'
    assert user3 == 'user3'
